...
entry point in a fresh translation unit, reads the compiler-generated dependency
file, and then builds a tiny CMake consumer against the real
...
exports a private/internal include directory, and
`mazda/internal_contracts.hpp` is still publicly reachable. This check is
intentionally not required CI yet.
